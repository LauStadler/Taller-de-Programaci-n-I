...
public class TestCombi {
	...
	public void testConstructor() {
  	 ...
  	 //Este metodo testea la obtencion del puntaje de la combi para un pedido para 6 personas, sin mascotas y baul, de 3 km y a zona peligrosa
		@Test
		...
		//Este metodo testea la obtencion del puntaje de la combi para un pedido para dos personas, con  con mascotas y sin baul, de 3 km y a zona peligrosa
		@Test
		public void testGetPuntaje2() {
			
			Pedido pedido = new Pedido(new Cliente("jorge", "1234", "Jorge"), 2, true, false, 3, Constantes.ZONA_PELIGROSA);
